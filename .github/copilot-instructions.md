...
`docs/assets/profile.png` — Profile image used in the hero card. Add `docs/assets/profile.webp` for best performance.
...
- - Assets: Replace `docs/assets/profile.png` (or `docs/assets/profile.svg`) in `docs/assets/` and keep the filename to avoid index changes; optionally provide `docs/assets/profile.webp` for improved compression.

...
const toggleLabel = toggle ? toggle.querySelector('.label') : { textContent: '' };
...
function renderPosts() {
  if (!blogList || !searchInput || !template) return;
  blogList.innerHTML = '';
...
renderFilters();
renderPosts();
// Root-level script imports docs/script.js so Pages from root still work
import('./docs/script.js');
